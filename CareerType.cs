...
{
    public partial class CareerType : Form
    {
        public CareerType()
        {
            InitializeComponent();
        ...
        private void typeOfcarrerBindingNavigatorSaveItem_Click(object sender, EventArgs e)
        {
            this.Validate();
            this.typeOfcarrerBindingSource.EndEdit();
