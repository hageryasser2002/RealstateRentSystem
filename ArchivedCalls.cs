...
{
    public partial class ArchivedCalls : Form
    {
        public Boolean go = false;

        public ArchivedCalls()
        {
            InitializeComponent();
            go = true;
        }
        ...
        private void Calls_Load(object sender, EventArgs e)
        {
            ...
            // TODO: This line of code loads data into the 'dSCalls.ArchiveCallRegistray' table. You can move, or remove it, as needed.
            this.archiveCallRegistrayTableAdapter.Fill(this.dSCalls.ArchiveCallRegistray);
        ...
        private void callsRegistrayDataGridView_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (e.ColumnIndex == 9)
            {
                ...
                {
                    archiveCallRegistrayTableAdapter.UpdateQuery(Utils.CallName, Utils.CallPlace, Utils.CallPlaceID, Convert.ToInt32(callsRegistrayDataGridView.CurrentCell.OwningRow.Cells[0].Value));
...
//                    callsRegistrayBindingNavigatorSaveItem.PerformClick();
        ...
        {
            //CallsArchive cl = new CallsArchive();
            //cl.ShowDialog();
        }

       
        private void callsRegistrayDataGridView_CellBeginEdit_1(object sender, DataGridViewCellCancelEventArgs e)
        {
            go = false;
        }
